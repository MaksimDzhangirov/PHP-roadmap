...
Использование на практике менеджера пакетов Composer позволяет автоматизировать не только процесс установки и обновления пакетов, но и дает возможность использовать одни и те же версии пакетов среди всех разработчиков.
...
Packagist — это хостинг PHP-пакетов. Это дефолтный хостинг Composer, и каждый месяц Composer используется для загрузки более 2 миллиардов пакетов. Packagist представляет собой один из крупнейших хостинговых сервисов в экосистеме PHP в целом.
